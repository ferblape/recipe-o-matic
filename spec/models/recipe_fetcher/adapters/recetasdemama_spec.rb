...
describe RecipeFetcher::Adapters::Recetasdemama do
  context 'given a recipe of curry' do
    ...
    it 'should be able to extract the ingredients' do
      expect(subject.ingredients).to eq(["700 g bonito del norte",
