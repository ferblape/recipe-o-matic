class RecipesController < ApplicationController
  before_action :admin_required, except: [:index, :show, :suggestion]
  before_action :load_recipe, only: [:new, :edit, :update, :new_form]
  ...
  def recipe_params
    params.require(:recipe).permit(:name, :text, :original_url, :image, :remote_image_url, :ingredients_text, :time, :season, :vegetarian,
